...
- Research time saved: ~5 hours/week per active collector
- Authentication coverage: 100% of listed items carry provenance documentation
- Discovery speed: ~3x faster find-to-inquiry vs. fragmented multi-platform workflow

## North Star Operations
- **Item Inquiry Submitted** — a buyer completes and sends a purchase inquiry for a listed piece
- **Item Saved to Collection** — a collector logs an owned piece or wishlists an item
